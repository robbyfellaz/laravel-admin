    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form class="form-horizontal" method="post" action="{{route('trendingtag.store')}}">
                    {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control {{ $errors->has('custom_url') ? ' is-invalid' : '' }}" name="custom_url" placeholder="Add Custom URL">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control {{ $errors->has('order') ? ' is-invalid' : '' }}" name="order" placeholder="Add Order" required>
                                @if($errors->has('order'))
                                <div class="text-danger">
                                    {{ $errors->first('order')}}
                                </div>
